...
const scenes = ["pickCatScene","showPromptScene","sceneB"]
export default class genericButton extends Phaser.GameObjects.Sprite {
    constructor(config) {
        ...
        config.scene.add.text(config.x, config.y, config.text,{ fontFamily: 'MinecraftiaRegular', fontSize: '18px',align:'left',stroke: '#000000',strokeThickness: 4,resolution:10  })
        .setOrigin(0.5)
        .setDepth(4);
    }
}
