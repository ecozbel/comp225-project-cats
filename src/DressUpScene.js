...
class DressUpScene extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        addAllClothing(this);
        //Adds clothing assets to the scene
        ...
        //DEsignate snap points for clothing assets on cat
        utilities.createClothingSnapPoints(cat);
        //Align items in closet in a grid
        ...
        //Get prompt and place current cat's name in it
        ...
        .setDepth(4)
        .setVisible(false);
        //Button to pop up prompt reminder
        ...
        promptReminderButton.on('pointerdown', function(){
            togglePromptBox(promptReminderBox,promptReminderText);
        },self );
        promptReminderBox.showing = false;
        //Toggle the visibility of promptBoc
        function togglePromptBox(promptReminderBox,promptReminderText){
        ...
        */
        ...
        //return sprite to closet if not on the cat
